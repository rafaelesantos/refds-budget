...
public final class FilterMiddleware<State>: RefdsReduxMiddlewareProtocol {
    ...
    private func getCategories(for filter: FilterViewDataProtocol) -> [FilterItemViewDataProtocol] {
    ...
    private func getTags() -> [FilterItemViewDataProtocol] {
    ...
    private func getStatus() -> [FilterItemViewDataProtocol] {
