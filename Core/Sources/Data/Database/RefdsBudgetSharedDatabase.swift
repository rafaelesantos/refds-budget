...
public final class RefdsBudgetSharedDatabase: RefdsBudgetDatabaseProtocol {
        ...
        let description = RefdsCoreDataModelDescription(entities: [
            ...
            .entity(
                ...
                attributes: [
                    ...
                    .attribute(name: "appearance", type: .doubleAttributeType, isOptional: true),
    ...
    private lazy var container: NSPersistentCloudKitContainer = {
        let container = NSPersistentCloudKitContainer(name: "SharedApplicationEntity", managedObjectModel: self.coreDataModel)
        guard let storeURL = try? URL.storeURL(for: "group.budget.widget", databaseName: "SharedApplicationEntity") else { fatalError("Error to create container") }
        let storeDescription = NSPersistentStoreDescription(url: storeURL)
        storeDescription.cloudKitContainerOptions = NSPersistentCloudKitContainerOptions(containerIdentifier: "iCloud.br.com.rafaelescaleira.SharedBudget")
