...
public enum Asset: String, CaseIterable, Identifiable {
    case mainCornerIcon = "MainCornerIcon"
    ...
    public var title: String {
        switch self {
        case .appIcon: return .localizable(by: .appIconAppIcon)
        ...
        case .developerMainIcon: return .localizable(by: .appIconDeveloperMainIcon)
        ...
        case .mainCornerIcon: return .localizable(by: .appIconMainCornerIcon)
