        ...
        if let state = state {
            RefdsSection {
                VStack {
                    ...
                    RefdsText(amount.currency(), style: .largeTitle, weight: .black)
                    RefdsText(budget.currency(), style: .callout, color: .accentColor, weight: .bold)
                    Divider()
                        .padding(.top)
                        .padding(.trailing, -40)
                        .padding(.leading, -15)
                        ...
                        HStack(spacing: .padding(.medium)) {
                            ...
                            VStack(alignment: .leading, spacing: .padding(.extraSmall)) {
                                HStack {
                                    ...
                                    Spacer(minLength: .zero)
                                    RefdsText(budget.amount.currency(), style: .callout)
                                }
