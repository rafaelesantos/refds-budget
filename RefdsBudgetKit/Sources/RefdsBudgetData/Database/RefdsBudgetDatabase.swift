...
public final class RefdsBudgetDatabase: RefdsBudgetDatabaseProtocol {
    ...
    private lazy var container: NSPersistentCloudKitContainer = {
        ...
        guard let storeURL = try? URL.storeURL(for: "group.budget.widget", databaseName: "ApplicationEntity") else { fatalError("Error to create container") }
